...
describe("URLParameter", () => {
  ...
  describe("#replaceURLParameter", () => {
    ...
    it(`${url} replace search param foo with test should be ${newurl1}`, () => {
      assert.strictEqual(url1, newurl1);
    });

    it(`${url} replace search param foo2 with haha should be ${newurl2}`, () => {
    ...
    it(`${url3} replace search param key with plan should be ${newurl31}`, () => {
  ...
  describe("#removeURLParameter", () => {
    ...
    it(`${url} remove search param foo should be ${newurl1}`, () => {
      assert.strictEqual(url1, newurl1);
    });

    it(`${url} remove search param f should be ${newurl2}`, () => {
      assert.strictEqual(url2, newurl2);
    });

    it(`${url} remove search param foo1 should be ${newurl3}`, () => {
    ...
    it(`${url4} remove search param f should be ${newurl41}`, () => {
    ...
    it(`${url8} remove search param f should be ${newurl81}`, () => {
    ...
    it(`${url} remove search param t should be ${newurl5}`, () => {
      assert.strictEqual(url5, newurl5);
    });
    it(`${url} remove search param t1 should be ${newurl6}`, () => {
      assert.strictEqual(url6, newurl6);
    });
    it(`${url} remove search param t2 should be ${newurl7}`, () => {
      assert.strictEqual(url7, newurl7);
    });

    it("/foo?onlyOneParam remove search param onlyOneParam should be /foo", () => {
