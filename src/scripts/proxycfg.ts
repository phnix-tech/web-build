...
const DFT_PROXY_OPT: Partial<Proxy> = {
  secure: false,
  changeOrigin: true
};
/**
 ...
 */
const dftProxyTable: ProxyTable = {};
...
function cfgCustomizedProxy (
  customizedProxyPath?: string,
  customizedProxyHost?: string,
  customizedRewriteFrom?: string,
  customizedRewriteTo?: string
) {
  // 去除前后空格
 ...
 *
 * @see https://github.com/chimurai/http-proxy-middleware
 * @param proxyTable 代理配置表
 * @returns
 */
function convert (proxyTable: ProxyTable) {
